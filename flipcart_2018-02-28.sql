...
# Database: flipcart
# Generation Time: 2018-02-28 10:57:49 +0000
# ************************************************************
...
VALUES
	(43,8,'Anonymous:<br>nice product','Positive',NULL),
	(44,8,'Anonymous:<br> very bad service nice screen good sound systems','Negative',NULL),
	(45,8,'Anonymous:<br> very good service','Positive',NULL),
	(46,2,'Anonymous:<br> very good samsung','Positive',NULL),
	(47,8,'Anonymous:<br> very good service. very nice screen','Positive',NULL),
	(48,7,'Anonymous:<br> nice screen','Positive',NULL),
	(49,2,'prajakta:<br>nice','Positive',NULL),
	(50,7,'Anonymous:<br> bad','Negative',NULL),
	(51,1,'prajakta:<br> good','Positive','12'),
	(52,1,'prajakta:<br> very good','Positive','12'),
	(53,1,'prajakta:<br> bad','Negative','12'),
	(54,1,'prajakta:<br> bad','Negative','12'),
	(55,1,'prajakta:<br> very bad','Negative','12'),
	(56,1,'prajakta:<br> good','Positive','12'),
	(57,1,'prajakta:<br> good','Positive','12'),
	(58,1,'prajakta:<br> bad','Negative','12'),
	(59,1,'prajakta:<br> bad','Negative','12'),
	(60,1,'prajakta:<br> gyghghg','Neutral','12'),
	(61,1,'prajakta:<br> ggggg','Neutral','12');
...
VALUES
	...
	(12,'prajakta',12231312,'praju@gmail.com','123',NULL,NULL);
